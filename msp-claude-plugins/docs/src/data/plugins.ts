...
export const plugins: Plugin[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'api-patterns', description: 'Use this skill when working with the N-central MCP tools — User-API Token (JWT) authentication via the `X-NCentral-*` gateway headers, 1-based pagination with the totalItems/totalPages envelope, rate-limit behavior, preview-endpoint caveats, and on-prem server specifics.' }
    ],
    agents: [
