...
description: >
  N-central MCP fundamentals: User-API Token (JWT) authentication through
  Conduit, 1-based pagination with the totalItems/totalPages envelope,
  rate-limit behavior, preview-endpoint caveats, and on-prem server
  specifics.
when_to_use: >-
