...
description: >
  N-central org units: the service organization -> customer -> site
  hierarchy, the org-unit vs customer distinction, agent registration
  tokens (credential-sensitive), and custom properties at both org and
  device level.
when_to_use: >-
